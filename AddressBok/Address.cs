...
namespace Addressbook
{
    ...
    {
        List<Contacts> add_book = new List<Contacts>();          //created an address book list of contact class type
        public void create()
        {
            int ch = 1;                                     //for choice of more contacts adding ....initially adds a contact
            do
            {
                Contacts Contact = new Contacts();                    //created an object of the Contact class and added contact details
